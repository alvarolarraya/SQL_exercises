...
CREATE TABLE Proveedores_Anulados
AS SELECT * FROM Proveedores WHERE 1=0;

INSERT INTO  Proveedores_Anulados  ( codigpro , cifpro , nombrpro , direcpro , cpostpro ,  localpro  ,telefpro,  procepro ) VALUES  ('P000','A39184210','Perez Perez, Pedro','Estafeta 3, 2º','31001','Pamplona','(34) 948 111 222','UE');

CREATE TABLE clientes
AS SELECT codigpro as codigcli, nombrpro as nombrcli, localpro as localcli
FROM PROVEEDORES WHERE codigpro in ('P001','P002');

INSERT INTO  clientes  ( codigcli , nombrcli , localcli ) VALUES  ('P005','Sanchez Sanchez, Sancho','Pamplona');
